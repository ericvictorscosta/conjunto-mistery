...
import { FrameDefault } from "../../data/carrosselSecundary"
...
const CarrosselSecundary = ({ imageFooter, idProduto }) => {
  ...
  return (
    <>
      {/* <CarrosselContainer>
        <HeaderCarrossel>
          <TitleCarrossel>PROMOÇÃO EXCLUSIVA</TitleCarrossel>
      ...
      <FooterCarrossel>
        ...
        {/* <ImageFooter
          src={
            "https://cdn.shopify.com/s/files/1/0738/4249/1684/files/BannerAdquira.png?v=1680275949" ||
            imageFooter
          }
