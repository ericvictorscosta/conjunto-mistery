...
function BolsaCouroLovely() {
  ...
  const handleButtonClick = () => {
    // window.location.href = "https://adquirindo-ofertas2.pay.yampi.com.br/r/K7FJC7SKVU"

    navigate(`/checkout/42`)
...
export default BolsaCouroLovely
