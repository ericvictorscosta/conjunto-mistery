...
function PistolaVap() {
  ...
  const handleButtonClick = () => {
    window.location.href =
      "https://adquirindo-ofertas.checkout.adoorei.com/r/6QEYTC9Cp52L9D9p9"

    // navigate(`/checkout/13`)
        ...
        <section className="first-page">
          ...
          <Row>
            ...
            <PriceCtn id="sectionRef" ref={minhaSecaoRef}>
              ...
              <Estoque quantidade={45} />
              <Cronometro time={1100000} />
            </PriceCtn>
          </Row>
        </section>

        <Section className="description-page">
          <TituloText>{Db.Descricao.primeiroTitulo}</TituloText>
          <ImageComponent imagesrc={Db.Descricao.image1} />

          <TituloText>{Db.Descricao.segundoTitulo}</TituloText>
          <ul style={{ textAlign: "left", paddingLeft: "20px" }}>
            <li>
              <TextItem>{Db.Descricao.item1}</TextItem>
            </li>
            <li>
              <TextItem>{Db.Descricao.item2}</TextItem>
            </li>
            <li>
              <TextItem>{Db.Descricao.item3}</TextItem>
            </li>
            <li>
              <TextItem>{Db.Descricao.item4}</TextItem>
            </li>
            <li>
              <TextItem>{Db.Descricao.item5}</TextItem>
            </li>
          </ul>
