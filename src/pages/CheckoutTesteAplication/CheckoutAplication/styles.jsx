...
export const BumpContainer = styled.div`
  ...
  .ctn_bump .input_image {
    display: flex;
    align-items: start;
  }

  .ctn_bump .input_image input {
    width: 18px;
    height: 18px;
  }

  .ctn_bump .input_image .content_bump {
    display: flex;
    flex-direction: column;
    text-align: center;
  ...
  .ctn_bump .input_image .content_bump img {
    width: 100%;
    height: auto;
  }

  .ctn_bump .input_image .content_bump  p {
    font-size: 14px;
    margin-left: 10px;
    font-weight: 500;
    color: #333333;
