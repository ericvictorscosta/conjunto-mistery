...
import ImageSecurity from "../assets/images/seguro.webp"
import ImageFeedback from "../assets/images/positivo.webp"
import ImageReembolso from "../assets/images/ree.webp"
import ImageCards from "../assets/images/carton.webp"
...
import GarantiaImage from "../assets/images/garantia.png"
import LogoFundoTransparente from "../assets/images/LOGO FUNDO TRANSPARENTE.png"
import "./styles"
...
function Checkout() {
  ...
  // Token de produção
  const accessToken = "A984011F-9AC89EF8-711894C9-EE7A57C7"
  ...
  function handleSubmitCredit() {
    ...
    if (
            ...
            .then((response) => {
              ...
              axios
                ...
                .then((response) => {
                  ...
                  fbq("track", "Purchase", {
                    value: precoTotalComBump,
                    currency: "BRL",
                    payment_method: "CREDIT_CARD",
                    order_status: "VENDA REALIZADA",
                  })
      ...
      setErrorInputs("Por favor, preencha todos os campos corretamente")
    }
  }
    ...
    <Container>
      ...
      <Content>
        <FormWrapper className="formulario">
          <ImageGarantiaCnt>
            <ImageGarantia src={GarantiaImage} alt="Selo de Garantia" />
          </ImageGarantiaCnt>
          ...
          <Text>Para quem devemos enviar o pedido?</Text>
          <DivErrorInputs>
            <InputWrapper>
              <InputMask
                type="email"
            ...
            {existBump == true ? (
              <>
                <h3 style={{ textAlign: "center", marginBottom: "10px" }}>
                  Aproveite e leve também um Kit Incrivel Para Compressor de Ar
                </h3>
                <BumpContainer>
                  <div className="ctn_bump">
                    ...
                    <div className="input_image">
                      ...
                      />
                      <div className="content_bump">
                        <img
                          src={produto.bump.imagem}
          ...
          {/* <ImageLoja>
            <img src={LogoFundoTransparente} alt="" />
          </ImageLoja> */}

          <div className="ctnEndFooter">
            <div className="text">
              <span>
            ...
            <div className="imgSecurity">
              <img
                src="https://melhores-ofertas-do-brasil.mycartpanda.com/images/icon-ssl.svg"
                alt="Logo"
              />
              <img
                src="https://melhores-ofertas-do-brasil.mycartpanda.com/images/CP_TECNOLOGIA.png"
                alt="Logo"
              />
              <img
                src="https://melhores-ofertas-do-brasil.mycartpanda.com/images/icon-secure.svg"
                alt="Logo"
              />
            </div>
          </div>
          ...
          <div className="wrapper" style={{ width: "100%", maxWidth: "475px" }}>
            ...
            >
              ...
              <div style={{ padding: "0 15px", width: "100%" }}>
                ...
                >
                  R$ {(itemCount * produto.preco).toFixed(2).toString().replace(".", ",")}
                </p>
              </div>
              <div
                style={{
